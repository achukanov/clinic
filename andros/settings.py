"""
Django settings for andros project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'clinic.context_processors.context_tags',
            ],
        },
    },
]

WSGI_APPLICATION = 'andros.wsgi.application'
